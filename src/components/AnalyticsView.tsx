...
export default function AnalyticsView({ locations, reports, emotions }) {
  ...
  useEffect(() => {
    ...
    const fetchAreaReport = async () => {
      ...
      try {
        const response = await fetch(
          `http://localhost:5000/api/analytics/detailed-report-area?area_name=${selectedArea}`
        );
    ...
    const fetchLocationReport = async () => {
      ...
      try {
        const response = await fetch(
          `http://localhost:5000/api/analytics/detailed-report-location?location_id=${selectedLocation}`
        );
        const data = await response.json();
    ...
    const fetchLocationReportBreakdown = async () => {
      ...
      try {
        const response = await fetch(
          `http://localhost:5000/api/analytics/location-reports?location_id=${selectedLocation}`
        );
        const data = await response.json();
    ...
    const fetchLocationEmotionTrends = async () => {
      ...
      try {
        const response = await fetch(
          `http://localhost:5000/api/analytics/location-emotions?location_id=${selectedLocation}`
        );
        const data = await response.json();
